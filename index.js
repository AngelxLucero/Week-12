...
//     static getAllHouses() {
//         HouseServices.getAllHouses().then(houses => this.render(houses));
//     }
...
class DOMManager {
    ...
    static createHouse(name) { //! create house works but doesn't render
    ...
    static deleteRoom(houseId,roomId){ //* working
        for (let house of this.houses){
